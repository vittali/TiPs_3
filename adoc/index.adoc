= Choosing a toolchain for a bluetooth (BLE) connected sensor
...
// Refs:
// TI
:r0: https://github.com/vittali/TiPs_3[compagnion repo]
...
:r8: https://vittali.ch/TiPs_4[Getting started with the TI SensorTag CC1350]
